# Homework 2 - *incognitochat*

**incognitochat** is a Ruby on Rails blog application that allows users to send messages to each other that can only be read once.

Submitted by: **Duy Pham**

Time spent: **12** hours

URL: **https://incognitochat.herokuapp.com/**
...
![Video Walkthrough](https://raw.githubusercontent.com/duyphamattinypulsecom/incognitochat/master/demo.gif)
